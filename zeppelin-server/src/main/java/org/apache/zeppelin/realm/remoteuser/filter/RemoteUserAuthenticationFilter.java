...
package org.apache.zeppelin.realm.remoteuser.filter;
...
public final class RemoteUserAuthenticationFilter extends AuthenticatingFilter {
    ...
    protected String getRemoteUserHeader(ServletRequest request) {
        ...
        return httpRequest.getHeader(remoteUserHeaderName);
    }
    ...
    public RemoteUserAuthenticationToken createToken(String user, Set<String> roles) {
        return new RemoteUserAuthenticationToken(user, roles);
    }
